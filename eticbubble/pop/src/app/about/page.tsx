      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="prose dark:prose-invert max-w-none">
          <p className="mb-4">
            ...
            curriculum at ETIC_Algarve, under the supervision of Giz, We Can
            Train You - a certified training entity in Portugal. Our platform
            explores the concept of digital minimalism through a unique social
            sharing experience.
          </p>
          ...
          <p className="mb-4">
            ...
            standards of user privacy and data protection, the project's code
            and user information are accessible to ETIC_Algarve's teachers and
            trainers for educational purposes only.
          </p>

          <p className="mb-4">
            We use only essential cookies for user authentication, and we're
            committed to maintaining a safe, respectful environment for all
            users. Your data will never be sold or shared with third parties.
          </p>
        </div>
      </div>
    </Suspense>
